...
// operator — -tuner wired DisabledTuner, -proposer's space-separated value discarded
// every flag after it, and a since-removed -machine-class seeded class-averaged
// priors while logging that it had applied class-specific ones.
//
